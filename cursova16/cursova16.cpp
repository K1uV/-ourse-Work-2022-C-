...
// cursova16.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Ccursova16App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

SystemProgram program;
// Создание Ccursova16App

Ccursova16App::Ccursova16App()
{
...
// Единственный объект Ccursova16App

Ccursova16App theApp;


// Инициализация Ccursova16App

BOOL Ccursova16App::InitInstance()
{
